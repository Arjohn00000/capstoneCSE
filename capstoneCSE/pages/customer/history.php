...
<body>
    ...
    <div class="main-container d-flex">
        ...
        <div class="content">
            ...
            <!-- Start Body -->
            <section class="history pb-5 mt-5">
                <div class="container">
                    <div class="history">
                        <div class="inner-wrap row p-3">
                            <h1 class=" mb-4 text-center fw-bold mt-5">My History</h1>
            ...
            <!-- End Body -->
             ...
             <section>
                <div class="container">
                    <div class="modal mt-4" id="history">
                            ...
                            <div class="modal-content mt-4">
                                <div class="modal-body">
                                    ...
                                    <div class="form-area bg-white rounded-4">
                                        <h1 class="text-center text-info">Review Order</h1>
                                        <form>
                                            <div class="mb-2 mt-4">
