...
<body>
    ...
    <div class="main-container d-flex">
        ...
        <div class="content">
            ...
            <!-- Start Body -->
            <section class="basketList pb-5 mt-5">
                <div class="container">
                    <div class="basket">
                        <div class="inner-wrap row p-3">
                            <h1 class=" mb-4 text-center fw-bold mt-5">My Basket</h1>
                            <div class="col-12 col-lg-3">
                                <div class="col mb-3">
                                    <input type="search" class="form-control" placeholder="Search Resere Product">
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td data-label="ACTION">
                                                <button data-bs-toggle="modal" data-bs-target="#basket"
            ...
            <section>
                <div class="container">
                    <div class="modal mt-4" id="basket">
                            ...
                            <div class="modal-content mt-4">
                                <div class="modal-body">
                                    ...
                                    <div class="form-area bg-white rounded-4">
                                        <h1 class="text-center text-info">Review Basket</h1>
                                        <form>
                                            <div class="mb-2 mt-4">
                                            ...
                                            <div class="mb-2">
                                                <input type="text" class="form-control" placeholder="5:00 min left" readonly>
                                            </div>
                                            <div class="mb-2">
